...
%Problem3 time stepping method by using Heun's method
%With headwind 15kn
...
%in case 1, with headwind 15kn conditon,
...
Plotmeinput.title          = 'Headwind Time stepping Co-plotting forces as a function of V^2 '; % Specify the plot title
...
Plotmeinput.filename       = 'headwind 15kn  Time stepping force(V^2) compare';   % Provide a filename to the figure being saved
...
Plotmeinput.ylabelname     = 'F';                    
Plotmeinput.title          = 'headwind 15kn Time stepping Co-plotting forces as a function of t '; % Specify the plot title
Plotmeinput.legendoption   = 'On';                % Use 'Off' when plotting a single curve. Use 'On' when plotting two or more curves on the same graph
Plotmeinput.legendnames    = {'Drag(t)', 'Lift(t)', 'Thrust(t)','Weight(t)', 'Normal(t)'};   % Provide the Legend entries here
Plotmeinput.filename       = 'headwind 15kn  Time steppingforce(t) compare';   % Provide a filename to the figure being saved
Plotmeinput.nVar           = 5;     % Number of curves being plotted on the same graph
Plotme(Plotmeinput) 
...
Plotmeinput.ylabelname     = 'F';                    
Plotmeinput.title          = 'headwind 15kn Time stepping Co-plotting forces as a function of S '; % Specify the plot title
Plotmeinput.legendoption   = 'On';                % Use 'Off' when plotting a single curve. Use 'On' when plotting two or more curves on the same graph
Plotmeinput.legendnames    = {'Drag(S)', 'Lift(S)', 'Thrust(S)','Weight(S)', 'Normal(S)'};   % Provide the Legend entries here
Plotmeinput.filename       = 'headwind 15kn Time stepping Method force(S) compare';   % Provide a filename to the figure being saved
Plotmeinput.nVar           = 5;     % Number of curves being plotted on the same graph
Plotme(Plotmeinput) 
...
Plotmeinput.title          = 'headwind 15kn Time stepping Co-plotting S,V,a as a function of S '; % Specify the plot title
Plotmeinput.legendoption   = 'On';                % Use 'Off' when plotting a single curve. Use 'On' when plotting two or more curves on the same graph
Plotmeinput.legendnames    = {'d(S)', 'V(S)', 'a(S)'};   % Provide the Legend entries here
Plotmeinput.filename       = 'headwind 15kn Time stepping Method for d(S), V(S), a(S) compare';   % Provide a filename to the figure being saved
...
Plotmeinput.xlabelname     = 't';                
Plotmeinput.ylabelname     = 'S,V,a';                    
Plotmeinput.title          = 'headwind 15kn Time stepping Co-plotting S,V,a as a function of t '; % Specify the plot title
Plotmeinput.legendoption   = 'On';                % Use 'Off' when plotting a single curve. Use 'On' when plotting two or more curves on the same graph
Plotmeinput.legendnames    = {'d(t)', 'V(t)', 'a(t)'};   % Provide the Legend entries here
Plotmeinput.filename       = 'headwind 15kn Time stepping Method for d(t), V(t), a(t) compare';   % Provide a filename to the figure being saved
Plotmeinput.nVar           = 3;     % Number of curves being plotted on the same graph
Plotme(Plotmeinput) 
